...
**/
void _icmp_socket_close( Dynamic handle )
{
...
**/
void _icmp_socket_send_char( Dynamic o, int c )
{
...
**/
int _icmp_socket_send( Dynamic o, Array<unsigned char> buf, int p, int l )
{
   SOCKET sock = val_sock(o);
   int dlen = buf->length;
...
**/
int _icmp_socket_recv( Dynamic o, Array<unsigned char> buf, int p, int l )
{
   SOCKET sock = val_sock(o);
   int dlen = buf->length;
   if( p < 0 || l < 0 || p > dlen || p + l > dlen )
...
**/
int _icmp_socket_recv_char( Dynamic o )
{
   SOCKET sock = val_sock(o);
...
**/
void _icmp_socket_write( Dynamic o, Array<unsigned char> buf )
{
   SOCKET sock = val_sock(o);
...
**/
Array<unsigned char> _icmp_socket_read( Dynamic o )
{
   SOCKET sock = val_sock(o);
...
**/
int _icmp_host_resolve( String host )
{
   unsigned int ip;
...
**/
String _icmp_host_to_string( int ip )
{
   struct in_addr i;
   *(int*)&i = ip;
...
**/
String _icmp_host_reverse( int host )
{
   struct hostent *h = 0;
...
String _icmp_host_reverse_ipv6( Array<unsigned char> host )
{
...
**/
void _icmp_socket_connect( Dynamic o, int host, int port )
{
...
**/
void _icmp_socket_connect_ipv6( Dynamic o, Array<unsigned char> host, int port )
{
...
**/
void _icmp_socket_listen( Dynamic o, int n )
{
   SOCKET sock = val_sock(o);
   hx::EnterGCFreeZone();
...
**/
Array<Dynamic> _icmp_socket_select( Array<Dynamic> rs, Array<Dynamic> ws, Array<Dynamic> es, Dynamic timeout )
{
   SOCKET n = 0;
   fd_set rx, wx, ex;
   fd_set *ra, *wa, *ea;
...
/**
   ...
   <doc>Perform the [select] operation. Timeout is in seconds or [null] if infinite</doc>
**/
void _icmp_socket_fast_select( Array<Dynamic> rs, Array<Dynamic> ws, Array<Dynamic> es, Dynamic timeout )
{
   SOCKET n = 0;
   fd_set rx, wx, ex;
   fd_set *ra, *wa, *ea;
...
**/
void _icmp_socket_bind( Dynamic o, int host, int port )
{
   SOCKET sock = val_sock(o);
...
/**
   ...
   <doc>Bind the socket for server usage on the given host and port</doc>
**/
void _icmp_socket_bind_ipv6( Dynamic o, Array<unsigned char> host, int port )
{
   SOCKET sock = val_sock(o);
...
Dynamic _icmp_socket_accept( Dynamic o )
{
   SOCKET sock = val_sock(o);
   struct sockaddr_in addr;
...
**/
Array<int> _icmp_socket_peer( Dynamic o )
{
   SOCKET sock = val_sock(o);
   struct sockaddr_in addr;
   SockLen addrlen = sizeof(addr);
...
**/
Array<int> _icmp_socket_host( Dynamic o )
{
   SOCKET sock = val_sock(o);
   struct sockaddr_in addr;
   SockLen addrlen = sizeof(addr);
...
**/
void _icmp_socket_set_timeout( Dynamic o, Dynamic t )
{
   SOCKET sock = val_sock(o);
...
**/
void _icmp_socket_shutdown( Dynamic o, bool r, bool w )
{
   SOCKET sock = val_sock(o);
   if( !r && !w )
      return;
...
void _icmp_socket_set_blocking( Dynamic o, bool b )
{
   SOCKET sock = val_sock(o);
   hx::EnterGCFreeZone();
#ifdef NEKO_WINDOWS
...
void _icmp_socket_set_fast_send( Dynamic o, bool b )
{
   SOCKET sock = val_sock(o);
   int fast = (b);
   hx::EnterGCFreeZone();
...
void _icmp_socket_set_broadcast( Dynamic o, bool b )
{
   SOCKET sock = val_sock(o);
   int broadcast = (b);
   hx::EnterGCFreeZone();
...
Dynamic _icmp_socket_poll_alloc( int nsocks )
{
...
**/
Array<Dynamic> _icmp_socket_poll_prepare( Dynamic pdata, Array<Dynamic> rsocks, Array<Dynamic> wsocks )
{
...
**/
void _icmp_socket_poll_events( Dynamic pdata, double timeout )
{
   polldata *p = val_poll(pdata);
...
**/
Array<Dynamic> _icmp_socket_poll( Array<Dynamic> socks, Dynamic pdata, double timeout )
{
   polldata *p = val_poll(pdata);

   _icmp_socket_poll_prepare(pdata,socks,null());

   _icmp_socket_poll_events(pdata,timeout);
